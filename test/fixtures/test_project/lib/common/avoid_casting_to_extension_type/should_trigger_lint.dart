...
void fn(String input) {
  ...
  final value1 = input as ET; // ignore: unused_local_variable

  // expect_lint: avoid_casting_to_extension_type
  final value2 = input as ET1; // ignore: unused_local_variable
}
