...
class ShouldNotTriggerLint extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final widget2 = Row(spacing: 8, children: [Text('Left'), Text('Right')]);
    ...
    final widget4 = Row(
      children: [Text('Left'), SizedBox(width: 50, height: 50), Text('Right')],
    );

    // Case 5: Column without any SizedBox - should NOT trigger
    final widget5 = Column(children: [Text('One'), Text('Two'), Text('Three')]);
